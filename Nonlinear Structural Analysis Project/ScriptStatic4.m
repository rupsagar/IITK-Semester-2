% PORTAL FRAME MODEL WITH DISPLACEMENT-CONTROLLED STATIC ANALYSIS WITH A GIVEN DISPLACEMENT HISTORY
clear;
format shortg;
...
DispIncr = 0.005;
DispCtrlDataSeries = [0,0.4,-0.2,0.6,-0.4,-0.2,0.8,0.3,0.6,0.3];
...
% OPENSEES RESULTS
system('"OpenSees.exe" ScriptStatic4.tcl');
