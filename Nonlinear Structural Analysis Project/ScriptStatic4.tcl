...
uniaxialMaterial $ReinfMat $ReinfMatTag $Fy $Es $Bs $R0 $cR1 $cR2
...
element $ElementType 2 2 3 $ColTransfTag $IntType $ColSecTag $numIntgrPts;
element $ElementType 3 3 4 $ColTransfTag $IntType $ColSecTag $numIntgrPts;
...
algorithm Newton;
set DispCtrlDOF 1;
set Disp "0 0.4 -0.2 0.6 -0.4 -0.2 0.8 0.3 0.6"
set DispIncr 0.005;
