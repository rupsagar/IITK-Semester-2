% CANTILEVER MODEL WITH MENEGOTTO-PINTO ISOTROPIC HARDENING AND
% DISPLACEMENT-CONTROLLED ANALYSIS WITH A GIVEN DISPLACEMENT HISTORY
clear;
format shortg;
...
IntType = "Lobatto";
NumSec = 5;
MatModel = {"GMP",415e6,210e9,.003,20,0.925,0.15,0.05,1,0.07,1};
NumFib = 20;
...
% OPENSEES RESULTS
system('"OpenSees.exe" ScriptStatic5.tcl');
